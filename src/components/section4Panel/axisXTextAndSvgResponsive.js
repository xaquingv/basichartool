...
export default function() {
  ...
  const elTest = document.querySelector(".js-test")
  ...
  const indent = parseInt(elAxisX.dataset.yIndent, 10)// || 0
  const textStrLeft = (indent + elsTick[0].offsetLeft) - elsText[0].offsetWidth / 2
  const textEndRight = (axisXWidth - elsTick[iLast].offsetLeft) - elsText[iLast].offsetWidth / 2
  if (textStrLeft < 0) {
